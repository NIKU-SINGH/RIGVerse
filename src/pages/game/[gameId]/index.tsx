                ...
                <div className='flex w-full overflow-hidden'>
                        ...
                        <div className='flex w-full ml-32 md:ml-64 flex-col px-4 mt-4'>
                                <div className='w-full'>
                                        <h1 className='text-3xl text-gray-200 font-bold'>Game : {game?.name}</h1>
                                        <p className='text-lg text-gray-400 mt-4'>{game?.description || "Step into the world of magic with Hogwarts an open-world action RPG set in the 1800s wizarding world. Forge your destiny as a student at Hogwarts School of Witchcraft and Wizardry."}</p>
                                </div>
                                <div className='bg-gray-800 h-screen w-full rounded-2xl my-10'>
                                        <div className="relative h-full w-full cursor-pointer overflow-hidden rounded-2xl group">
                                                ...
                                                <div className='flex flex-col bottom-0 absolute px-4 py-2 w-full rounded-lg h-64' style={{
