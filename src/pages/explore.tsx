...
const topRatedGames = [
  {
    ...
    description:
      "A curated list of the highest-rated games across various genres, celebrated for their engaging gameplay, compelling narratives, and artistic innovation.",
    enpoint: "/game",
    games: [
      {
        id: 17,
      ...
      },
      {
        ...
        image: "/games/codmw.jpg",
        description:
          "A mesmerizing world filled with puzzles and breathtaking landscapes.",
      ...
      },
      {
        ...
        image: "/games/cypherpunk.jpg",
        description:
          "A visually stunning, emotionally charged platformer that's a sequel to Ori and the Blind Forest.",
      ...
      },
      {
        ...
        image: "/games/codPoster.jpg",
        description:
          "An action-packed adventure with an 8-bit retro aesthetic.",
      ...
      },
      {
        ...
        image: "/games/gow.jpg",
        description:
          "A run and gun platformer with unique visuals inspired by 1930s cartoons.",
        category: ["Run and Gun", "Indie", "Action"],
