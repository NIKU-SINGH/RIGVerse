                        ...
                        <div className='absolute my-10'>
                            <div className="relative inline-flex h-[85vh] w-80  overflow-hidden rounded-e-xl p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                                ...
                                <div className="inline-flex flex-col gap-4 p-2  h-full w-full cursor-pointer rounded-e-xl bg-slate-950 px-3 py-1 text-sm font-medium text-white backdrop-blur-3xl">
                                    <Button className="z-10" onClick={toggleExpanded}>Collapse</Button>
                                    <ScrollArea className="h-[100vh] rounded-xl  p-4">
                                        <div className=''>
                                            ...
                                            <Link href='/recent-matches'>
                                                <Button variant="outline" className="w-full bg-transparent border-primary hover:bg-primary hover:text-white">View All</Button>
                                            </Link>
                                        </div>
                                        ...
                                        <div className='mt-8'>
                                            ...
                                            <div>
                                                <PurchaseCard name="Call of Duty" price="100" imageUrl="/games/codPoster.jpg" description="It is the most popular game" />
                                                <PurchaseCard name="Fifa" price="100" imageUrl="/games/fifa19.jpg" description="It is the most popular game" />
                                                <PurchaseCard name="COD MW3" price="100" imageUrl="/games/codmw.jpg" description="It is the most popular game" />
                                                <PurchaseCard name="Assasins Creed" price="100" imageUrl="/games/creed4.jpg" description="It is the most popular game" />
                                                <PurchaseCard name="Valorant" price="100" imageUrl="/games/valorant1.jpg" description="It is the most popular game" />
