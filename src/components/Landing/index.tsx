    ...
    return (
        <div className="h-[40rem] rounded-3xl relative w-[80vw] bg-black flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="w-full flex items-center justify-center mt-8 ">
                {/* <button className="w-96 relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
