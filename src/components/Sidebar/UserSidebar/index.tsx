...
import { LayoutDashboard, List, LineChart, MessageCircleCode, Wallet, SquarePen, Gamepad2, User, Menu, Settings, Home } from "lucide-react";
...
export default function CreateGameSidebar() {
    ...
    const buttonLinks = [
        {
            title: "Home",
            href: `/user/${studioId}/home`,
            icon: <Home className="h-6 w-6" />,
        },
        // {
        //     title: "Comments",
        //     href: `/user/${studioId}/comments`,
        //     icon: <MessageCircleCode className="h-6 w-6" />,
        // },
        {
            title: "Create Post",
            href: `/user/${studioId}/create-post`, // Update with the correct path
            icon: <SquarePen className="h-6 w-6" />,
        },
        {
            title: "Profile",
            href: `/user/${studioId}/`, // Update with the correct path
